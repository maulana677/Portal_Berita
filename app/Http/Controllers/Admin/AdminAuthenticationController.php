...
class AdminAuthenticationController extends Controller
{
    ...
    public function sendResetLink(SendResetLinkRequest $request)
    {
        ...
        return redirect()->back()->with('success', __('admin.An email has been sent to your email address, please check it!'));
    }
    ...
    public function handleresetPassword(AdminResetPasswordRequest $request)
    {
        ...
        return redirect()->route('admin.login')->with('success', __('admin.Password changed successfully'));
    }
}
