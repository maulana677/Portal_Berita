...
class AdminAuthenticationController extends Controller
{
    ...
    public function sendResetLink(SendResetLinkRequest $request)
    {
        ...
        return redirect()->back()->with('success', __('admin.Email telah dikirim ke alamat email Anda, silakan periksa!'));
    }
    ...
    public function handleresetPassword(AdminResetPasswordRequest $request)
    {
        ...
        return redirect()->route('admin.login')->with('success', __('admin.Kata sandi berhasil diubah'));
    }
}
