                    ...
                    <div class="wrapp__list__article-responsive wrapp__list__article-responsive-carousel">
                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="./blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/news1.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="./blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/news2.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/news3.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/news4.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/news5.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div class="item">
                            ...
                            <div class="card__post card__post-list">
                                <div class="image-sm">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/news6.jpg') }}" class="img-fluid"
                                            alt="">
                                    </a>
                                </div>
                        ...
                        <div class="card__post-carousel">
                            <div class="item">
                                ...
                                <div class="card__post">
                                    <div class="card__post__body">
                                        <a href="blog_details.html">
                                            <img src="{{ asset('frontend/assets/images/newsimage1.png') }}"
                                                class="img-fluid" alt="">
                                        </a>
                            ...
                            <div class="item">
                                ...
                                <div class="card__post">
                                    <div class="card__post__body">
                                        <a href="blog_details.html">
                                            <img src="{{ asset('frontend/assets/images/newsimage2.png') }}"
                                                class="img-fluid" alt="">
                                        </a>
                                        <div class="card__post__content bg__post-cover">
                                            <div class="card__post__category">
                        ...
                        <div class="popular__news-right">
                            ...
                            <div class="card__post ">
                                <div class="card__post__body card__post__transition">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/newsimage3.png') }}"
                                            class="img-fluid" alt="">
                                    </a>
                                    <div class="card__post__content bg__post-cover">
                                        <div class="card__post__category">
                            ...
                            <div class="card__post ">
                                <div class="card__post__body card__post__transition">
                                    <a href="blog_details.html">
                                        <img src="{{ asset('frontend/assets/images/newsimage4.png') }}"
                                            class="img-fluid" alt="">
                                    </a>
                                    <div class="card__post__content bg__post-cover">
                                        <div class="card__post__category">
                        ...
                        <div class="top__news__slider">
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/newsimage5.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/newsimage6.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/newsimage7.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/assets/images/newsimage8.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-12 col-md-6 mb-4">
                                ...
                                <div class="card__post ">
                                    <div class="card__post__body card__post__transition">
                                        <a href="blog_details.html">
                                            <img src="{{ asset('frontend/assets/images/newsimage9.png') }}"
                                                class="img-fluid" alt="">
                                        </a>
                                        <div class="card__post__content bg__post-cover">
                                            <div class="card__post__category">
                                ...
                                <div class="wrapp__list__article-responsive">
                                    <div class="mb-3">
                                        ...
                                        <div class="card__post card__post-list">
                                            <div class="image-sm">
                                                <a href="blog_details.html">
                                                    <img src="{{ asset('frontend/assets/images/news1.jpg') }}"
                                                        class="img-fluid" alt="">
                                                </a>
                                            </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="card__post card__post-list">
                                            <div class="image-sm">
                                                <a href="blog_details.html">
                                                    <img src="{{ asset('frontend/assets/images/news2.jpg') }}"
                                                        class="img-fluid" alt="">
                                                </a>
                                            </div>
                                ...
                                <div class="wrapp__list__article-responsive">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="card__post card__post-list">
                                            <div class="image-sm">
                                                <a href="blog_details.html">
                                                    <img src="{{ asset('frontend/assets/images/news4.jpg') }}"
                                                        class="img-fluid" alt="">
                                                </a>
                                            </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="small_add_banner">
                            <div class="small_add_banner_img">
                                <img src="{{ asset('frontend/assets/images/placeholder_large.jpg') }}"
                                    alt="adds">
                            </div>
                        </div>
